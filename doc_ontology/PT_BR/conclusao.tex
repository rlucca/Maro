...
linguagem \OWL 2.
%
% nao esquecer de botar aqui uma fala de o que se pensava de ontologia de
% percepcao e o que terminou sendo e relatar um porque...
%
% Isso aqui que foi por agua abaixo que me referia:
%%Por exemplo, um desenvolvedor só precisa conhecer a ontologia de percepção proposta para saber\dev{} o que o agente deve enviar de crenças ou percepções e o que esperar em retorno.
...
%tambem eh importante re-ler, tudo e arrumar a introducao.
%eu tive impressao lendo que o ultimo paragrafo esta incorreto. (25/10)

%posicionamento das figuras tem que ser revisto!
