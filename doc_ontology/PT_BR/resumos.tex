...
agentes envolvidos na simulação. As preferências são baseadas em anotações
\cite{doyle1998annotated} criadas juntos dos objetos enquanto o comportamento
é baseado em uma ontologia existente de modelagem de ambiente urbano
\cite{paiva2005ontology}.
\end{abstract}
