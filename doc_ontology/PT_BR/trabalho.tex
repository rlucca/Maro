...
características estáticas\todo{esSA frase eu aChei meio esquisitA}.
...
\begin{figure}
  \centering
    \includegraphics[width=150mm]{figuras/occ_todos_geral.png}
...
\begin{figure}
  \centering
  \begin{tabular}{cc}
  \includegraphics[height=8cm]{figuras/occ_todos_dph.png} & \includegraphics[height=8cm]{figuras/occ_todos_oph.png} \\
  (i) Relações de dados & (ii) Relações de Objetos
  \end{tabular}
...
\begin{figure}
  \centering
  \includegraphics[height=4cm]{figuras/doloresConfig.png}
...
\begin{figure}
  \centering
  \begin{tabular}{cc}
  \includegraphics[height=4cm]{figuras/doloresInferencia1.png} & \includegraphics[height=4cm]{figuras/doloresInferencia2.png} \\
...
\begin{figure}
  \centering
  \begin{tabular}{cc}
  \includegraphics[height=4cm]{figuras/appraisalEx3.png} & \includegraphics[height=4cm]{figuras/infEx3.png} \\
...
\begin{figure}
  \centering
  \begin{tabular}{cc}
  \includegraphics[height=4cm]{figuras/appraisalEx4.png} & \includegraphics[height=4cm]{figuras/infEx4.png} \\
  (a) Configuração & (b) Resultado
  \end{tabular}
...
% 297 de altura e tudo no x acho q nao passo de 815

\begin{figure}
  \centering
  \begin{tabular}{cc}
  \includegraphics[height=4cm]{figuras/appraisalEx5.png} & \includegraphics[height=4cm]{figuras/infEx5.png} \\
  (a) Configuração & (b) Resultado
  \end{tabular}
...
\begin{figure}
  \centering
  \begin{tabular}{cc}
  \includegraphics[height=4cm]{figuras/appraisalEx9preparo.png} & \includegraphics[height=4cm]{figuras/infEx9preparo.png} \\
  (a) Configuração & (b) Resultado
  \end{tabular}
  \caption{Avaliação ...}
