...
%\include{assinaturas} % Maybe the last stuff or the first?
...
\include{resumo} % inclui o resumo da lingua nativa e estrangeira
...
%\input{avaliacao}
% Bordini:
%    trocar hasKnow por hasMet?
%    trocar hasJudge por hasEud?
%    nao existe hasJudgeness!!
%    O que ajuda no projeto de animacoes as preferencias que sao individuais
%    	estarem no ambiente e nao na mente do agente?
%    Como a funcao updateByType funciona?
%	 Uso de ?query nao esta correto pq sao feitas accoes nos planos
%	 O que é realizedCalculation?
\input{conclusao}
