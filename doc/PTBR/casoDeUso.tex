...
...
\todo{comprometimento. Mostrar aqui um arquivo de projeto jason usando opcoes no agente}
\todo{Nao eh ontologia de anotacoes eh ontologia de preferencia usando anotacoes}
