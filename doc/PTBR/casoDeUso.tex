...
arquitetura do agente (\emph{agentArchClass}) e o raciocinador do agente
(\emph{agentClass}). Essas alterações foram explicadas anteriormente.
%na seção~\ref{ch:p:ipjo}.
...
e o valor atual é 8 então o agente terá o sentimento com o valor 2 que será
...
\section{Nome nao definido} \label{ch:cdu:home}
