...
regulamentar. Em cada turno é sorteado um número randômico de 0 à 1000 e se o
estiver a baixo de 100 então é porque saiu gol. Nesse caso, o valor abaixo de
50 vai para o time direito e o valor superior ou igual vai para o time
esquerdo.

Esse exemplo simples propicia um cenário bastante rico para as emoções por
causa que um personagem pode ter diferentes emoções sendo disparadas aqui.
Essas emoções são muitas vezes do ramo de consequências de eventos que tem
haver com a desejabilidade do evento ou do ramo de ações de agentes que tem
haver com os padrões do agentes.

Os agentes que estão assistindo ao jogo de futebol decidem no inicio da
simulação os nomes de seus times. Ambos acreditam que seus times vão ganhar e
esperam ter um gol logo no primeiro tempo.
