...
construído a partir de uma ontologia de rotinas e um mecanismo simples que
permite a avaliação automática das emoções baseando-se nas anotações dos
objetos foi construído utilizando uma ontologia de preferência sobre essas
anotações. Dessa forma, aplicações de entretenimento poderiam utilizar o
sistema ou as ontologias apresentadas para diferentes propósitos. A criação de
...
principais grupos emotivos do modelo afetivo. Além disso, um exemplo de uma
casa foi criada com a finalidade de demonstrar as três ontologias trabalhando
juntas.
\end{abstract}
