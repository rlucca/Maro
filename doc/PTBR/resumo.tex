...
utilizadas no ambiente foram criadas. Dessa forma, aplicações de
entretenimento poderiam utilizar as três ontologias juntas para criar um mapa
da cidade, para criar as rotinas de cada agente e para dar preferências sobre
as anotações utilizadas nas crenças vindas do ambiente. Para validação desse
desenvolvimento, um exemplo de jogo de futebol foi utilizado e este atingiu os
principais grupos emotivos do modelo afetivo.
\end{abstract}
