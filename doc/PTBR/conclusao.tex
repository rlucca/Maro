...
Além disso, remover a necessidade de o calcula da potência da emoção ser feita
...
com o \jason e em separado com uma \emph{a-box} que foi usada para ver se
todas as conclusões esperadas estavam corretas. Os pontos de melhora dessa
...
seus principais elementos por serem artefatos reutilizares. Infelizmente, o
objetivo de ter uma configuração mínima não foi alcançado e nem o objetivo de
não possuir regras para ajudar a inferência. Entretanto, esse último objetivo
foi removido porque na versão 2 da \emph{OWL} as regras são parte da linguagem
e, por isso, foram utilizam.
